package leaf.snowflake;

import com.google.common.base.Preconditions;
import leaf.IDGen;
import leaf.common.Result;
import leaf.common.Status;
import leaf.common.Utils;
...
public class SnowflakeIDGenImpl implements IDGen {
    ...
    public synchronized Result get(String key) {
        ...
        LOGGER.info("生成的id为:{}", id);
        long ids = id >> timestampLeftShift;

        LOGGER.info("修改之后的id为:{}", ids + twepoch);
