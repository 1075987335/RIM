...
public class UnprocessedRequests {
     ...
     * 私聊消息的ACKList
     */
    private Map<Long, IM_Message> P2P_UNPROCESS_MAP = new ConcurrentHashMap<>();

    /**
     * 群聊消息的ACKList
     */
    private Map<String, IM_Message> GROUP_UNPROCESS_MAP = new ConcurrentHashMap<>();

    /**
     * 保存TID和IM_Message的映射关系，针对群聊来说，因为群聊一个消息可能会有多个确认
     */
    private Map<Long, IM_Message> TID_CACHE = new ConcurrentHashMap<>();
